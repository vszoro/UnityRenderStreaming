...
#if UNITY_EDITOR
        [MenuItem("Test/CreateRenderStreamingSettings")]
        public static void SerializeTest()
        {
            var i = 2;
            var setting = ScriptableObject.CreateInstance<RenderStreamingSettings>();
            setting.signalingSettings = (i % 4) switch
            {
                0 => new HttpSignalingSettings(),
                1 => new WebSocketSignalingSettings(),
                2 => new FurioosSignalingSettings(),
                3 => new TestSignalingSettings(),
                _ => setting.signalingSettings
            };

            AssetDatabase.CreateAsset(setting, $"Assets/RenderStreamingSettings_{i}.asset");
